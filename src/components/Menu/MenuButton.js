...
export default function MenuButton(){
    ...
    return(
        ...
        <>
        {!menuOpened ? <button className="hamburger" onClick={()=>{animateMenu()}}><img alt="Hamburger" src={ham} width="25" height="25"/> </button>: <button alt="Croix" className="cross" onClick={()=>{animateMenu()}}><img alt="icon" src={cross} width="25" height="25"/></button>}
        </>
